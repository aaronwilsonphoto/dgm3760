...
<html lang="en">
  ...
  <div class="jumbotron">
    ...
    $query = "SELECT * FROM employee_simple WHERE approved=1";
        ...
        <div id="collapseThree'.$row['id'].'" class="collapse" role="tabpanel" aria-labelledby="'.$row['id'].'">
          <div class="card-block">
            <div class="row">
              ...
              <br>Email - ' .$row['email']. ' 
              <br>Phone - ' .$row['phone']. '
              <br>Date Created - '. $row['date'] .'
              <br><br><a style="color: green;" href="updateEmployee.php?id='.$row['id'].'">[update employee]</a>
              </div>
            </div>
          </div>
        </div>
