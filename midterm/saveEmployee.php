...
if ($validImage == true) {
  ...
  // BUILD THE QUERY
  $query = "INSERT INTO research_division (date, first, last, email, phone, photo, specialization, expertise) VALUES ('$date', '$first', '$last', '$email', '$phone', '$filename', '$specialization', '$expertise')";
...
<html lang="en">
  ...
  <h2><br />Employee Profile Successfully Created</h2>
  ...
  echo        '<div class="row">
              ...
              <br>Email - ' .$email. ' 
              <br>Phone - ' .$phone. '
              <br>Area of Expertise - ' .$expertise. '
              <br>Area of specialization - ' .$specialization. '
              </div>
              </div>'
